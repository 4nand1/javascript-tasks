...
//   list.innerHTML = filteredContent
//     .map((item, i) => ListItem(item, content.indexOf(item)))
//     .join("");

//   document.querySelectorAll(".delete-btn").forEach((btn, i) => {
//     btn.addEventListener("click", () => {
//       content = content.filter(
//         (_, index) => index !== content.indexOf(filteredContent[i])
//       );
//       render();
//     });
//   });

//   document.querySelectorAll(".complete-checkbox").forEach((checkbox, i) => {
//     checkbox.addEventListener("change", () => {
//       const realIndex = content.indexOf(filteredContent[i]);
//       content[realIndex].completed = checkbox.checked;
//       render();
//     });
//   });
// };
